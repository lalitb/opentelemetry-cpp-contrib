set(CPACK_PACKAGE_DESCRIPTION "OpenTelemetry C++ Geneva Exporter")
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "OpenTelemetry C++ Geneva Exporter - Geneva Exporter for OpenTelemetry")
set(CPACK_PACKAGE_VENDOR "OpenTelemetry")
set(CPACK_PACKAGE_CONTACT "opentelemetry-cpp-contrib")
set(CPACK_PACKAGE_HOMEPAGE_URL "https://opentelemetry.io/")
set(CMAKE_PROJECT_NAME "opentelemetry-cpp-geneva")
set(OPENTELEMETRY_GENEVA_VERSION "1.0")
...
if (UNIX AND NOT APPLE)
    ...
    set(CPACK_PACKAGE_FILE_NAME "${CMAKE_PROJECT_NAME}-${OPENTELEMETRY_GENEVA_VERSION}-${CPACK_SYSTEM_NAME}-${CMAKE_SYSTEM_PROCESSOR}")
...
elseif(WIN32)
    ...
    if(NOT NUGETCAPABLE MATCHES "NOTFOUND")
        ...
        set(CPACK_NUGET_PACKAGE_VERSION "${OPENTELEMETRY_GENEVA_VERSION}")
